...
if TYPE_CHECKING:
    ...
    from fastmcp_client.client.client import CallToolResult, Client
from fastmcp_client.client.progress import ProgressHandler
from fastmcp_client.client.tasks import ToolTask
from fastmcp_client.client.telemetry import client_span
from fastmcp_client.exceptions import ToolError
from fastmcp_client.telemetry import inject_trace_context
from fastmcp_client.utilities.json_schema_type import json_schema_to_type
from fastmcp_client.utilities.logging import get_logger
from fastmcp_client.utilities.timeout import normalize_timeout_to_timedelta
from fastmcp_client.utilities.types import get_cached_typeadapter
...
async def _parse_call_tool_result(
    ...
    from fastmcp_client.client.client import CallToolResult
