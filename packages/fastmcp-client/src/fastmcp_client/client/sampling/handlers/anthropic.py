...
try:
    ...
    raise ImportError(
        ...
        "Install it with `pip install fastmcp-client[anthropic]` or add `anthropic` to your dependencies."
    ) from e
...
class AnthropicSamplingHandler:
    ...
    Example:
        ...
        from fastmcp_client.client.sampling.handlers.anthropic import AnthropicSamplingHandler
