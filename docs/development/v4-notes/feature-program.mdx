...
In this PR, sampling still functions on the legacy eras and is not yet deprecation-warned — the deprecation and era-gating land as the first follow-up PR.
