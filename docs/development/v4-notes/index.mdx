...
The user-facing summary of the migration lives in the published [Upgrading to MCP SDK v2](/getting-started/upgrading/to-mcp-sdk-v2) guide. These development notes are the exhaustive version behind it.
