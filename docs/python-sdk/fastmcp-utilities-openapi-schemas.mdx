...
### `extract_output_schema_from_responses` <sup><a href="https://github.com/PrefectHQ/fastmcp/blob/main/fastmcp_slim/fastmcp/utilities/openapi/schemas.py#L638" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
