...
<ParamField body="description" type="str | None">
  Provides the description exposed via MCP. If set, the function's docstring is ignored for this purpose. You can use this to dynamically set the description.
</ParamField>
