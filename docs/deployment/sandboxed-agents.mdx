...
Narrow tools are easier to audit, easier to authorize, and easier for agents to use reliably. They also let you express different policies per tool instead of creating one large privileged escape hatch.
