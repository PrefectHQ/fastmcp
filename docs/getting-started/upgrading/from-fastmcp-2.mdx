...
For most servers, upgrading to v3 is straightforward — the core `from fastmcp import FastMCP` import and decorator APIs are unchanged. The breaking changes below affect constructor kwargs, a few renamed methods, and some less commonly used features.
