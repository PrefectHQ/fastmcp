...
<Columns cols={2}>
  <Tile href="#sales-dashboard" title="Sales Dashboard" description="Metrics, charts, and deal pipeline">
    <div style={{overflow: "hidden", width: "100%"}}>
      <img src="/apps/images/app-example-sales-dashboard.png" alt="Sales dashboard app with metrics, charts, and a deal pipeline" />
    </div>
  </Tile>
  <Tile href="#system-monitor" title="System Monitor" description="Live CPU, memory, disk with auto-refresh">
    <img src="/apps/images/app-example-system-dashboard.png" alt="System monitor app showing live CPU, memory, and disk usage" />
  </Tile>
  <Tile href="#quiz" title="Quiz" description="LLM-generated trivia with scoring">
    <img src="/apps/images/app-example-quiz.png" alt="Quiz app with an LLM-generated trivia question and score" />
  </Tile>
  <Tile href="#interactive-map" title="Interactive Map" description="Geocoded addresses on Leaflet">
    <img src="/apps/images/app-example-map.png" alt="Interactive map app with geocoded address markers" />
  </Tile>
  <Tile href="/apps/providers/file-upload" title="File Upload" description="Drag-and-drop upload provider">
    <img src="/apps/images/app-file-upload.png" alt="File upload app with a drag-and-drop area" />
  </Tile>
  <Tile href="/apps/providers/approval" title="Approval" description="Human-in-the-loop confirmation">
    <img src="/apps/images/app-approval.png" alt="Approval app asking the user to confirm an action" />
  </Tile>
  <Tile href="/apps/providers/choice" title="Choice" description="Clickable option selection">
    <img src="/apps/images/app-choice.png" alt="Choice app presenting clickable options" />
  </Tile>
  <Tile href="/apps/providers/form" title="Form Input" description="Pydantic model forms">
    <img src="/apps/images/app-form.png" alt="Form input app rendered from a Pydantic model" />
  </Tile>
  <Tile href="/apps/generative" title="Generative UI" description="LLM writes the UI at runtime">
    <img src="/apps/images/app-showcase.png" alt="Generative UI app written by the LLM at runtime" />
  </Tile>
</Columns>
