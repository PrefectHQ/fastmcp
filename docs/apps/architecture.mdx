...
description: How FastMCP Apps work under the hood.
icon: sitemap
---
...
This page explains the internal architecture of MCP Apps — how your Python code becomes an interactive UI inside a host client's conversation. You don't need to understand any of this to build apps, but the mental model is useful when you're debugging, extending, or building custom renderers.
