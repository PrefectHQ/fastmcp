...
[Prefab UI](/apps/prefab) is a Python component library that lets you build tool UIs without writing any HTML or JavaScript. Describe your layout in Python, and FastMCP handles the renderer and protocol wiring automatically.
