...
| `FASTMCP_HTTP_ALLOWED_ORIGINS` | `list[str] \| null` | `null` | Additional trusted browser origins for Streamable HTTP requests. Use a JSON array, such as `["https://app.example.com"]`. |
