...
SecureMCP extension settings are not part of `fastmcp.settings`. If you're using SecureMCP, configure it with `SECUREMCP_*` variables documented in [SecureMCP Settings](/servers/security/settings).
