...
<Update label="v4.0.7" description="2026-09-23">

**[v4.0.7: Double Take](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.7)**
...
### Fixes 🐞
* completions: check reference visibility through typed list hooks only by [@zzstoatzz](https://github.com/zzstoatzz) in [#5244](https://github.com/PrefectHQ/fastmcp/pull/5244)
* resources: cache compiled URI template patterns by [@zzstoatzz](https://github.com/zzstoatzz) in [#5245](https://github.com/PrefectHQ/fastmcp/pull/5245)


**Full Changelog**: [v4.0.6...v4.0.7](https://github.com/PrefectHQ/fastmcp/compare/v4.0.6...v4.0.7)

</Update>

<Update label="v4.0.6" description="2026-09-23">

**[v4.0.6: Comma Chameleon](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.6)**
...
### Enhancements ✨
* Name nested fields in detailed CodeMode schemas by [@zzstoatzz](https://github.com/zzstoatzz) in [#5111](https://github.com/PrefectHQ/fastmcp/pull/5111)
* Add a docs skill by [@zzstoatzz](https://github.com/zzstoatzz) in [#5175](https://github.com/PrefectHQ/fastmcp/pull/5175)
* Add constrained Fire TV tools to the smart-home example by [@zzstoatzz](https://github.com/zzstoatzz) in [#5187](https://github.com/PrefectHQ/fastmcp/pull/5187)
* transforms: add experimental JevSearchTransform by [@zzstoatzz](https://github.com/zzstoatzz) in [#5170](https://github.com/PrefectHQ/fastmcp/pull/5170)
* Expose FileSystemProvider discovery failures by [@spark-328](https://github.com/spark-328) in [#5164](https://github.com/PrefectHQ/fastmcp/pull/5164)
* Run Windows tests on main and manual runs only by [@zzstoatzz](https://github.com/zzstoatzz) in [#5198](https://github.com/PrefectHQ/fastmcp/pull/5198)
* Add langchain.mcp, ClientGroup, and a FastMCP proxy to the downstream smoke by [@zzstoatzz](https://github.com/zzstoatzz) in [#5222](https://github.com/PrefectHQ/fastmcp/pull/5222)
### Security 🔒
* fix(auth): keep Google access tokens out of request URLs by [@zzstoatzz](https://github.com/zzstoatzz) in [#5185](https://github.com/PrefectHQ/fastmcp/pull/5185)
* completions: answer only references the caller can list by [@zzstoatzz](https://github.com/zzstoatzz) in [#5240](https://github.com/PrefectHQ/fastmcp/pull/5240)
### Fixes 🐞
* codemode: raise legible errors in the sandbox; render enums and defaults in `get_schema` by [@zzstoatzz](https://github.com/zzstoatzz) in [#4970](https://github.com/PrefectHQ/fastmcp/pull/4970)
* fix(ci): stabilize Marvin label triage by [@zzstoatzz](https://github.com/zzstoatzz) in [#5197](https://github.com/PrefectHQ/fastmcp/pull/5197)
* fix(resources): percent-encode URI template literals (RFC 6570 §3.1) by [@LGUIUX](https://github.com/LGUIUX) in [#5167](https://github.com/PrefectHQ/fastmcp/pull/5167)
* fix(resources): encode data-backed file names by [@RaycarlLei](https://github.com/RaycarlLei) in [#5140](https://github.com/PrefectHQ/fastmcp/pull/5140)
* Preserve binary resource contents in response cache by [@brennanbutler01](https://github.com/brennanbutler01) in [#5181](https://github.com/PrefectHQ/fastmcp/pull/5181)
* fix(auth): preserve DNS resolver order when deduplicating resolved IP addresses (#5151) by [@seotarek](https://github.com/seotarek) in [#5157](https://github.com/PrefectHQ/fastmcp/pull/5157)
* Keep shared stdio sessions alive until the last client exits by [@Aurelucien](https://github.com/Aurelucien) in [#5180](https://github.com/PrefectHQ/fastmcp/pull/5180)
* fix(transforms): bound Jev search narrowing by [@zzstoatzz](https://github.com/zzstoatzz) in [#5199](https://github.com/PrefectHQ/fastmcp/pull/5199)
* fix(auth): cache OIDC discovery configuration by [@sui-ni2](https://github.com/sui-ni2) in [#4861](https://github.com/PrefectHQ/fastmcp/pull/4861)
* fix(resources): support exploded list query parameters by [@zzstoatzz](https://github.com/zzstoatzz) in [#5206](https://github.com/PrefectHQ/fastmcp/pull/5206)
* Keep string length and pattern constraints when a format is set by [@zzstoatzz](https://github.com/zzstoatzz) in [#5208](https://github.com/PrefectHQ/fastmcp/pull/5208)
* fix(openapi): rewrite model references in prefixItems by [@asts-top](https://github.com/asts-top) in [#5131](https://github.com/PrefectHQ/fastmcp/pull/5131)
* Accept integral float counts like minLength 2.0 in JSON schemas by [@zzstoatzz](https://github.com/zzstoatzz) in [#5214](https://github.com/PrefectHQ/fastmcp/pull/5214)
* Stop an unshared stdio subprocess when its session exits under cancellation by [@zzstoatzz](https://github.com/zzstoatzz) in [#5215](https://github.com/PrefectHQ/fastmcp/pull/5215)
* Match resource template literals whether they arrive raw or percent-encoded by [@zzstoatzz](https://github.com/zzstoatzz) in [#5216](https://github.com/PrefectHQ/fastmcp/pull/5216)
* Accept non-exploded list query params as comma-joined values by [@zzstoatzz](https://github.com/zzstoatzz) in [#5218](https://github.com/PrefectHQ/fastmcp/pull/5218)
* Revert shared keep_alive=False stdio sessions (#5180, #5215) by [@zzstoatzz](https://github.com/zzstoatzz) in [#5219](https://github.com/PrefectHQ/fastmcp/pull/5219)
* Render non-JSON schema defaults and enums in the markdown tool serializer by [@zzstoatzz](https://github.com/zzstoatzz) in [#5220](https://github.com/PrefectHQ/fastmcp/pull/5220)
* Tolerate JSON schema counts larger than any real length by [@zzstoatzz](https://github.com/zzstoatzz) in [#5221](https://github.com/PrefectHQ/fastmcp/pull/5221)
* Release a Client's session hold before any await when a context exits by [@zzstoatzz](https://github.com/zzstoatzz) in [#5223](https://github.com/PrefectHQ/fastmcp/pull/5223)
* ci: retry downstream version lookups and bind the wedge test's names by [@zzstoatzz](https://github.com/zzstoatzz) in [#5239](https://github.com/PrefectHQ/fastmcp/pull/5239)
### Docs 📚
* docs: explain HttpResource uri versus url by [@zzstoatzz](https://github.com/zzstoatzz) in [#5168](https://github.com/PrefectHQ/fastmcp/pull/5168)
* docs: fix version label and language dropdown overlap by [@zzstoatzz](https://github.com/zzstoatzz) in [#5172](https://github.com/PrefectHQ/fastmcp/pull/5172)
* docs: accessibility sweep by [@zzstoatzz](https://github.com/zzstoatzz) in [#5174](https://github.com/PrefectHQ/fastmcp/pull/5174)
* docs: fix dead links to relocated Anthropic and Docket docs by [@uhhgxg](https://github.com/uhhgxg) in [#5205](https://github.com/PrefectHQ/fastmcp/pull/5205)
* Update the Pydantic AI integration docs for MCPToolset and the 2.45 floor by [@zzstoatzz](https://github.com/zzstoatzz) in [#5211](https://github.com/PrefectHQ/fastmcp/pull/5211)
### Dependencies 📦
* chore(deps): bump the uv group across 2 directories with 3 updates by @dependabot[bot] in https://github.com/PrefectHQ/fastmcp/pull/5171
### Other Changes 🦾
* chore(deps): Update astral-sh/setup-uv action to v10.1.0 by @prefect-renovate[bot] in https://github.com/PrefectHQ/fastmcp/pull/5191

## New Contributors
* @LGUIUX made their first contribution in [#5167](https://github.com/PrefectHQ/fastmcp/pull/5167)
* @RaycarlLei made their first contribution in [#5140](https://github.com/PrefectHQ/fastmcp/pull/5140)
* @brennanbutler01 made their first contribution in [#5181](https://github.com/PrefectHQ/fastmcp/pull/5181)
* @seotarek made their first contribution in [#5157](https://github.com/PrefectHQ/fastmcp/pull/5157)
* @spark-328 made their first contribution in [#5164](https://github.com/PrefectHQ/fastmcp/pull/5164)
* @Aurelucien made their first contribution in [#5180](https://github.com/PrefectHQ/fastmcp/pull/5180)
* @uhhgxg made their first contribution in [#5205](https://github.com/PrefectHQ/fastmcp/pull/5205)

**Full Changelog**: [v4.0.5...v4.0.6](https://github.com/PrefectHQ/fastmcp/compare/v4.0.5...v4.0.6)

</Update>

<Update label="v4.0.5" description="2026-09-17">

**[v4.0.5: No Country for Loose Ints](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.5)**
...
### Security 🔒
* Add regression test for the unconfigured ID-JAG guard by [@zzstoatzz](https://github.com/zzstoatzz) in [#5146](https://github.com/PrefectHQ/fastmcp/pull/5146)
### Fixes 🐞
* Preserve field-level strict validation in lax mode by [@zzstoatzz](https://github.com/zzstoatzz) in [#5141](https://github.com/PrefectHQ/fastmcp/pull/5141)


**Full Changelog**: [v4.0.4...v4.0.5](https://github.com/PrefectHQ/fastmcp/compare/v4.0.4...v4.0.5)

</Update>

<Update label="v4.0.4" description="2026-09-15">

**[v4.0.4: Here Be No Dragons](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.4)**
...
### Enhancements ✨
* Refresh the smart-home example with Hue V2 and native effects by [@zzstoatzz](https://github.com/zzstoatzz) in [#5009](https://github.com/PrefectHQ/fastmcp/pull/5009)
* Update CodeMode for pydantic-monty 0.0.21 by [@strawgate](https://github.com/strawgate) in [#5033](https://github.com/PrefectHQ/fastmcp/pull/5033)
* Keep linked contributor PRs open while awaiting assignment by [@zzstoatzz](https://github.com/zzstoatzz) in [#5048](https://github.com/PrefectHQ/fastmcp/pull/5048)
* Reduce redundant CI execution while preserving required checks by [@zzstoatzz](https://github.com/zzstoatzz) in [#5049](https://github.com/PrefectHQ/fastmcp/pull/5049)
* Share and streamline repository skills by [@zzstoatzz](https://github.com/zzstoatzz) in [#5013](https://github.com/PrefectHQ/fastmcp/pull/5013)
* Support anthropic 1.x alongside 0.x by [@tdsmith](https://github.com/tdsmith) in [#5066](https://github.com/PrefectHQ/fastmcp/pull/5066)
* renovate: cap routine PRs at 5 concurrent and 5 per hour by [@zzstoatzz](https://github.com/zzstoatzz) in [#5110](https://github.com/PrefectHQ/fastmcp/pull/5110)
* Give docs quality checks a corpus-wide timeout by [@zzstoatzz](https://github.com/zzstoatzz) in [#5109](https://github.com/PrefectHQ/fastmcp/pull/5109)
* Resolve ty 0.0.79 warnings from upgrade checks by [@zzstoatzz](https://github.com/zzstoatzz) in [#5123](https://github.com/PrefectHQ/fastmcp/pull/5123)
### Security 🔒
* Fix #5115: OAuthProxy accepts self-contained ID-JAG tokens even when identity_ass by [@nandanadileep](https://github.com/nandanadileep) in [#5119](https://github.com/PrefectHQ/fastmcp/pull/5119)
### Fixes 🐞
* Fix upgrade checks for the M2M storage warning test by [@zzstoatzz](https://github.com/zzstoatzz) in [#5040](https://github.com/PrefectHQ/fastmcp/pull/5040)
* Fix OpenAPI query explode defaults by [@zzstoatzz](https://github.com/zzstoatzz) in [#5065](https://github.com/PrefectHQ/fastmcp/pull/5065)
* fix(openapi): encode JSON scalar request bodies by [@Gonghan-Princess](https://github.com/Gonghan-Princess) in [#5052](https://github.com/PrefectHQ/fastmcp/pull/5052)
* fix(versions): deterministic meta.fastmcp.versions ordering by [@feiiiiii5](https://github.com/feiiiiii5) in [#4880](https://github.com/PrefectHQ/fastmcp/pull/4880)
* Parse skills frontmatter with yaml.safe_load, falling back to the line parser by [@vishnujayvel](https://github.com/vishnujayvel) in [#4701](https://github.com/PrefectHQ/fastmcp/pull/4701)
* Keep client data out of tool validation warnings by [@zzstoatzz](https://github.com/zzstoatzz) in [#5106](https://github.com/PrefectHQ/fastmcp/pull/5106)
* fix: follow empty pagination cursors in client lists by [@sicauzxl](https://github.com/sicauzxl) in [#5026](https://github.com/PrefectHQ/fastmcp/pull/5026)
* fix: reject non-positive upstream token expiry by [@sui-ni2](https://github.com/sui-ni2) in [#4849](https://github.com/PrefectHQ/fastmcp/pull/4849)
* fix(server): reject a malformed pagination cursor offset by [@L4XB](https://github.com/L4XB) in [#5071](https://github.com/PrefectHQ/fastmcp/pull/5071)
* fix(openapi): preserve dictionary request bodies by [@asts-top](https://github.com/asts-top) in [#5097](https://github.com/PrefectHQ/fastmcp/pull/5097)
* Preserve OpenAPI raw body content types by [@pentaoa](https://github.com/pentaoa) in [#5093](https://github.com/PrefectHQ/fastmcp/pull/5093)
* fix(openapi): preserve HTTP parameters that match whole-body names by [@asts-top](https://github.com/asts-top) in [#5113](https://github.com/PrefectHQ/fastmcp/pull/5113)
* fix(local-provider): apply transforms in get_tasks by [@BlueX888](https://github.com/BlueX888) in [#5117](https://github.com/PrefectHQ/fastmcp/pull/5117)
* Fix multipart string-array default encoding by [@zzstoatzz](https://github.com/zzstoatzz) in [#5121](https://github.com/PrefectHQ/fastmcp/pull/5121)
### Other Changes 🦾
* chore(deps): Update github actions (major) by @prefect-renovate[bot] in https://github.com/PrefectHQ/fastmcp/pull/4890

## New Contributors
* @Gonghan-Princess made their first contribution in [#5052](https://github.com/PrefectHQ/fastmcp/pull/5052)
* @tdsmith made their first contribution in [#5066](https://github.com/PrefectHQ/fastmcp/pull/5066)
* @feiiiiii5 made their first contribution in [#4880](https://github.com/PrefectHQ/fastmcp/pull/4880)
* @vishnujayvel made their first contribution in [#4701](https://github.com/PrefectHQ/fastmcp/pull/4701)
* @sicauzxl made their first contribution in [#5026](https://github.com/PrefectHQ/fastmcp/pull/5026)
* @sui-ni2 made their first contribution in [#4849](https://github.com/PrefectHQ/fastmcp/pull/4849)
* @L4XB made their first contribution in [#5071](https://github.com/PrefectHQ/fastmcp/pull/5071)
* @asts-top made their first contribution in [#5097](https://github.com/PrefectHQ/fastmcp/pull/5097)
* @pentaoa made their first contribution in [#5093](https://github.com/PrefectHQ/fastmcp/pull/5093)
* @BlueX888 made their first contribution in [#5117](https://github.com/PrefectHQ/fastmcp/pull/5117)
* @nandanadileep made their first contribution in [#5119](https://github.com/PrefectHQ/fastmcp/pull/5119)

**Full Changelog**: [v4.0.3...v4.0.4](https://github.com/PrefectHQ/fastmcp/compare/v4.0.3...v4.0.4)
...
### Enhancements ✨
* Expose ClientGroup from package root by [@jlowin](https://github.com/jlowin) in [#4987](https://github.com/PrefectHQ/fastmcp/pull/4987)
* skills: add release skill with changelog entry helper by [@zzstoatzz](https://github.com/zzstoatzz) in [#4982](https://github.com/PrefectHQ/fastmcp/pull/4982)
### Fixes 🐞
* docs: escape `<1` in changelog so MDX parses by [@zzstoatzz](https://github.com/zzstoatzz) in [#4978](https://github.com/PrefectHQ/fastmcp/pull/4978)
### Docs 📚
* docs: note the 4.0.1 floor for ClientGroup reentrancy by [@zzstoatzz](https://github.com/zzstoatzz) in [#4980](https://github.com/PrefectHQ/fastmcp/pull/4980)
* docs: link the GA announcement and blog from What's New by [@zzstoatzz](https://github.com/zzstoatzz) in [#4984](https://github.com/PrefectHQ/fastmcp/pull/4984)


**Full Changelog**: [v4.0.1...v4.0.2](https://github.com/PrefectHQ/fastmcp/compare/v4.0.1...v4.0.2)

</Update>

<Update label="v4.0.1" description="2026-09-01">

**[v4.0.1: Come Back Any Time](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.1)**
...
### Fixes 🐞
* client: make ClientGroup context reentrant by [@zzstoatzz](https://github.com/zzstoatzz) in [#4975](https://github.com/PrefectHQ/fastmcp/pull/4975)
* ci: fix the published-docs PR step's working base by [@zzstoatzz](https://github.com/zzstoatzz) in [#4960](https://github.com/PrefectHQ/fastmcp/pull/4960)
### Docs 📚
* docs: update banner for FastMCP 4 GA by [@zzstoatzz](https://github.com/zzstoatzz) in [#4958](https://github.com/PrefectHQ/fastmcp/pull/4958)
* docs: correct whats-new and upgrade guide for GA by [@zzstoatzz](https://github.com/zzstoatzz) in [#4961](https://github.com/PrefectHQ/fastmcp/pull/4961)
* docs: drop prerelease install framing from installation and SDK migration guides by [@zzstoatzz](https://github.com/zzstoatzz) in [#4963](https://github.com/PrefectHQ/fastmcp/pull/4963)
* docs: refresh sidebar tags and fix audit findings by [@zzstoatzz](https://github.com/zzstoatzz) in [#4965](https://github.com/PrefectHQ/fastmcp/pull/4965)

**Full Changelog**: [v4.0.0...v4.0.1](https://github.com/PrefectHQ/fastmcp/compare/v4.0.0...v4.0.1)

</Update>

<Update label="v4.0.0" description="2026-08-31">

**[v4.0.0: Four Real](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.0)**
...
* Add comprehensive Codex code review rules by [@jlowin](https://github.com/jlowin) in [#4710](https://github.com/PrefectHQ/fastmcp/pull/4710)
* Give parallel Windows CI more timeout headroom by [@zzstoatzz](https://github.com/zzstoatzz) in [#4680](https://github.com/PrefectHQ/fastmcp/pull/4680)
* add language dropdown to docs sidebar by [@znicholasbrown](https://github.com/znicholasbrown) in [#4716](https://github.com/PrefectHQ/fastmcp/pull/4716)
* Route published docs through pull requests by [@jlowin](https://github.com/jlowin) in [#4713](https://github.com/PrefectHQ/fastmcp/pull/4713)
* Improve HTTP server startup performance by [@jlowin](https://github.com/jlowin) in [#4729](https://github.com/PrefectHQ/fastmcp/pull/4729)
* Avoid loading MCP and CLI stacks during lightweight imports by [@jlowin](https://github.com/jlowin) in [#4763](https://github.com/PrefectHQ/fastmcp/pull/4763)
* Preserve legacy httpx compatibility without importing it by [@jlowin](https://github.com/jlowin) in [#4766](https://github.com/PrefectHQ/fastmcp/pull/4766)
* Clarify review of closed contributor PRs by [@jlowin](https://github.com/jlowin) in [#4780](https://github.com/PrefectHQ/fastmcp/pull/4780)
* Support EdDSA verification in JWTVerifier by [@zzstoatzz](https://github.com/zzstoatzz) in [#4752](https://github.com/PrefectHQ/fastmcp/pull/4752)
* Forward proxy server metadata across protocol eras by [@jakekaplan](https://github.com/jakekaplan) in [#4776](https://github.com/PrefectHQ/fastmcp/pull/4776)
* feat(renovate): migrate to Renovate, retire Dependabot by [@jamiezieziula](https://github.com/jamiezieziula) in [#4754](https://github.com/PrefectHQ/fastmcp/pull/4754)
...
* Encrypt task context snapshots at rest by [@chrisguidry](https://github.com/chrisguidry) in [#4772](https://github.com/PrefectHQ/fastmcp/pull/4772)
...
* client: deprecate inferring stdio transports from str, prefer Path by [@zzstoatzz](https://github.com/zzstoatzz) in [#4941](https://github.com/PrefectHQ/fastmcp/pull/4941)
### Fixes 🐞
...
* Always emit a tool title, derived from name when unset by [@jlowin](https://github.com/jlowin) in [#4694](https://github.com/PrefectHQ/fastmcp/pull/4694)
* Fix self-referential connection error causes by [@jakekaplan](https://github.com/jakekaplan) in [#4720](https://github.com/PrefectHQ/fastmcp/pull/4720)
* Write downloaded skill text as UTF-8 by [@zzstoatzz](https://github.com/zzstoatzz) in [#4715](https://github.com/PrefectHQ/fastmcp/pull/4715)
* Fix CodeMode tool error propagation by [@YAO-001](https://github.com/YAO-001) in [#4704](https://github.com/PrefectHQ/fastmcp/pull/4704)
* Forward enable_cimd to Auth0, AWS Cognito and OCI providers by [@StykMartin](https://github.com/StykMartin) in [#4719](https://github.com/PrefectHQ/fastmcp/pull/4719)
* fix: preserve valid servers during CLI discovery by [@ShuyingZhang](https://github.com/ShuyingZhang) in [#4714](https://github.com/PrefectHQ/fastmcp/pull/4714)
* Preserve string-compatible prompt arguments by [@jlowin](https://github.com/jlowin) in [#4730](https://github.com/PrefectHQ/fastmcp/pull/4730)
* Canonicalize response cache arguments by [@jlowin](https://github.com/jlowin) in [#4753](https://github.com/PrefectHQ/fastmcp/pull/4753)
* Serve empty list results from the response cache by [@LHMQ878](https://github.com/LHMQ878) in [#4738](https://github.com/PrefectHQ/fastmcp/pull/4738)
* Don't cache error results in ResponseCachingMiddleware by [@SaiMouli3](https://github.com/SaiMouli3) in [#4705](https://github.com/PrefectHQ/fastmcp/pull/4705)
* Declare run-claude extra allowed tools input by [@zzstoatzz](https://github.com/zzstoatzz) in [#4740](https://github.com/PrefectHQ/fastmcp/pull/4740)
* Sanitize forwarded request metadata where the proxy copies it by [@jakekaplan](https://github.com/jakekaplan) in [#4770](https://github.com/PrefectHQ/fastmcp/pull/4770)
* fix(context): move elicit overload docs inside the stubs so mypy sees the chain by [@yonatangross](https://github.com/yonatangross) in [#4774](https://github.com/PrefectHQ/fastmcp/pull/4774)
* Delegate typed tool output serialization to Pydantic by [@jlowin](https://github.com/jlowin) in [#4771](https://github.com/PrefectHQ/fastmcp/pull/4771)
* Serialize the event store's stream list read-modify-write by [@SaiMouli3](https://github.com/SaiMouli3) in [#4758](https://github.com/PrefectHQ/fastmcp/pull/4758)
...
* Accept any issuer scoped to the Descope project by [@gaokevin1](https://github.com/gaokevin1) in [#4909](https://github.com/PrefectHQ/fastmcp/pull/4909)
* Fix response cache partitioning for versioned components by [@CoralGarden52](https://github.com/CoralGarden52) in [#4948](https://github.com/PrefectHQ/fastmcp/pull/4948)
### Docs 📚
...
* Add v4.0.0b1 changelog and updates entries by [@jlowin](https://github.com/jlowin) in [#4681](https://github.com/PrefectHQ/fastmcp/pull/4681)
* Use mcp.types directly instead of aliasing to mcp_types in docs by [@jlowin](https://github.com/jlowin) in [#4696](https://github.com/PrefectHQ/fastmcp/pull/4696)
* Rewrite the v4 What's New page and document server extensions by [@jlowin](https://github.com/jlowin) in [#4698](https://github.com/PrefectHQ/fastmcp/pull/4698)
* Improve the v4 docs by [@jlowin](https://github.com/jlowin) in [#4707](https://github.com/PrefectHQ/fastmcp/pull/4707)
* Rewrite the FastMCP docs welcome page by [@jlowin](https://github.com/jlowin) in [#4709](https://github.com/PrefectHQ/fastmcp/pull/4709)
* docs: clarify external OAuth consent mode by [@jlowin](https://github.com/jlowin) in [#4746](https://github.com/PrefectHQ/fastmcp/pull/4746)
* Docs: mirror v3.4.6 changelog entries by [@jlowin](https://github.com/jlowin) in [#4764](https://github.com/PrefectHQ/fastmcp/pull/4764)
* Document MCP protocol support and conformance by [@jlowin](https://github.com/jlowin) in [#4781](https://github.com/PrefectHQ/fastmcp/pull/4781)
...
* docs: prepare FastMCP 4 beta 5 by [@zzstoatzz](https://github.com/zzstoatzz) in [#4934](https://github.com/PrefectHQ/fastmcp/pull/4934)
* docs: cover list_tools and restore client modules in the SDK reference by [@zzstoatzz](https://github.com/zzstoatzz) in [#4936](https://github.com/PrefectHQ/fastmcp/pull/4936)
* docs: transport inference trust contract; trim SDK session-group comparison by [@zzstoatzz](https://github.com/zzstoatzz) in [#4940](https://github.com/PrefectHQ/fastmcp/pull/4940)
### Dependencies 📦
* chore(deps): bump mcp from 1.26.0 to 1.27.2 in /examples/testing_demo in the uv group across 1 directory by [@dependabot[bot]](https://github.com/dependabot[bot]) in [#4514](https://github.com/PrefectHQ/fastmcp/pull/4514)
* chore(deps): bump actions/setup-node from 6 to 7 by [@dependabot[bot]](https://github.com/dependabot[bot]) in [#4546](https://github.com/PrefectHQ/fastmcp/pull/4546)
* Bump actions/upload-artifact from 4 to 7 by [@dependabot[bot]](https://github.com/dependabot[bot]) in [#4640](https://github.com/PrefectHQ/fastmcp/pull/4640)
* Bump actions/setup-python from 6 to 7 by [@dependabot[bot]](https://github.com/dependabot[bot]) in [#4641](https://github.com/PrefectHQ/fastmcp/pull/4641)
* chore(deps): bump mcp from 1.27.2 to 1.28.1 in /examples/testing_demo in the uv group across 1 directory by [@dependabot[bot]](https://github.com/dependabot[bot]) in [#4614](https://github.com/PrefectHQ/fastmcp/pull/4614)
### Other Changes 🦾
...
* Fix static analysis with latest ty by [@zzstoatzz](https://github.com/zzstoatzz) in [#4739](https://github.com/PrefectHQ/fastmcp/pull/4739)
* Quote run-claude allowed tools argument by [@zzstoatzz](https://github.com/zzstoatzz) in [#4741](https://github.com/PrefectHQ/fastmcp/pull/4741)
* chore(deps): Update j178/prek-action action to v3 by [@prefect-renovate[bot]](https://github.com/prefect-renovate[bot]) in [#4808](https://github.com/PrefectHQ/fastmcp/pull/4808)
* chore(deps): Update dependency node to v24 by [@prefect-renovate[bot]](https://github.com/prefect-renovate[bot]) in [#4807](https://github.com/PrefectHQ/fastmcp/pull/4807)
* chore(deps): Update astral-sh/setup-uv action to v9 by [@prefect-renovate[bot]](https://github.com/prefect-renovate[bot]) in [#4806](https://github.com/PrefectHQ/fastmcp/pull/4806)
...
* @znicholasbrown made their first contribution in [#4716](https://github.com/PrefectHQ/fastmcp/pull/4716)
* @YAO-001 made their first contribution in [#4704](https://github.com/PrefectHQ/fastmcp/pull/4704)
* @StykMartin made their first contribution in [#4719](https://github.com/PrefectHQ/fastmcp/pull/4719)
* @LHMQ878 made their first contribution in [#4738](https://github.com/PrefectHQ/fastmcp/pull/4738)
* @SaiMouli3 made their first contribution in [#4705](https://github.com/PrefectHQ/fastmcp/pull/4705)
* @yonatangross made their first contribution in [#4774](https://github.com/PrefectHQ/fastmcp/pull/4774)
* @jamiezieziula made their first contribution in [#4754](https://github.com/PrefectHQ/fastmcp/pull/4754)
...
* @CoralGarden52 made their first contribution in [#4948](https://github.com/PrefectHQ/fastmcp/pull/4948)

**Full Changelog**: [v3.4.7...v4.0.0](https://github.com/PrefectHQ/fastmcp/compare/v3.4.7...v4.0.0)
