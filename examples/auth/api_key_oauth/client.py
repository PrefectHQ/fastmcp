...
consent page. Enter any non-empty key (the demo server accepts anything) and the
connection completes. The `list_files` tool then runs with the key the server
recovered from your token.
